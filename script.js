...
const surpriseData = [
    { title: "🎁 Сердечко 1: Наши гулянки", text: "Я обожаю тратить с тобой свое время и ни капли не жалею о них,ты стал мне самым близким другом которого у меня никогда не было,я рада что ты у меня есть", image: './000.jpg', position: new THREE.Vector3(4, 3, 0), color: 0xff007f },
    { title: "💖 Сердечко 2: Веселые разговорчики", text: "Люблю говорить с тобой обо всем,в такие моменты кажется что все ебланы кроме нас", image: './2026-01-03 18.06.35.jpg', position: new THREE.Vector3(-4, 6, 1), color: 0x00ffff },
    { title: "🌟 Сердечко 3: Главное Пожелание", text: "Ашим, я желаю тебе достичь всего чего ты пожелаешь, и уверена что достигнешь ведь ты у нас целеустремленный,твоя подружка гордится тобой и твоими стараниями,продолжай быть таким прекрасным", image: './2026-01-03 18.06.42.jpg', position: new THREE.Vector3(0, 8, -2), color: 0xffff00 },
    { title: "🎈 Сердечко 4: Секретный Подарок", text: "если честно я хотела подарить тебе одну вещь о котором ты забыл,я знаю он бы тебе понравился,нооооо я скажу когда подарю ", image: './Снимок экрана 2026-01-03 в 21.04.44.png', position: new THREE.Vector3(5, 7, 3), color: 0xff00ff },
    { title: "💌 Сердечко 5: Моя вера в тебя", text: "Я знаю какой ты прекрасный человек и знаю что ты всего можешь достичь своими стараниями", image: './00.jpg', position: new THREE.Vector3(-5, 4, -3), color: 0x00ff00 },
    { title: "✨ Сердечко 6: Новые Приключения", text: "Ты стал мне самым близким другом которого у меня никогда не было,я рада что ты у меня есть", image: './2026-01-03 18.06.53.jpg', position: new THREE.Vector3(1, 9, 4), color: 0xffa500 },
    { title: "🥳 Сердечко 7: С Днем Рождения!", text: "С праздником, мой дорогой лучший друг! Я обожаю тебя и хочу чтобы мы также поддерживали друг друга ", image: './2026-01-03 18.05.43.jpg', position: new THREE.Vector3(-2, 2, 5), color: 0x9900ff },
    { title: "💍 Сердечко 8: Навсегда", text: "Твоя подружка гордится тобой и твоими стараниями,продолжай быть таким прекрасным ", image: './2026-01-03 18.06.42.jpg', position: new THREE.Vector3(4, 10, -1), color: 0xffffff }, // Белое
];
