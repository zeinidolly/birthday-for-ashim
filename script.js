...
const surpriseData = [
    { title: "🎁 Сердечко 1: Наши гулянки", text: "Я обожаю тратить с тобой свое время и ни капли не жалею о них", image: './000.jpg', position: new THREE.Vector3(4, 3, 0), color: 0xff007f },
    { title: "💖 Сердечко 2: Веселые разговорчики", text: "Люблю говорить с тобой обо всем,в такие моменты кажется что все ебланы кроме нас", image: './2026-01-03 18.06.28.jpg', position: new THREE.Vector3(-4, 6, 1), color: 0x00ffff },
    { title: "🌟 Сердечко 3: Главное Пожелание", text: "Ашим, я желаю тебе достичь всего чего ты пожелаешь, и уверена что достигнешь ведь ты у нас целеустремленный", image: './2026-01-03 18.05.43.jpg', position: new THREE.Vector3(0, 8, -2), color: 0xffff00 },
